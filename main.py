...
def check_new_user():
    ...
    if new_username == "" or new_password == "":
        ...
        lbl_must_input = tk.Label(empty_inputs, text="You must fill the boxs", foreground='black', font=("Press Start 2P", 6)).pack()
        lbl_can_close = tk.Label(empty_inputs, text="You may now close this window and try again", foreground='black', font=("Press Start 2P", 6)).pack()
    else:
        ### reads cvs 
        ...
        if new_username in user_data["username"].values or new_password != conf_password:
            ...
            lbl_reg_fail = tk.Label(reg_fail, text="Either that username already exists or the passwords do not match", foreground='black', font=("Press Start 2P", 6)).pack()
            lbl_can_close = tk.Label(reg_fail, text="You may now close this window and try again", foreground='black', font=("Press Start 2P", 6)).pack()
        else:
            registration_success = tk.Toplevel(window)
            registration_success.title("SUCCESS")
            registration_success.geometry('250x50')
            lbl_registration_success = tk.Label(registration_success, text="registration successful", foreground='black', font=("Press Start 2P", 6)).pack()
            lbl_can_close = tk.Label(registration_success, text="You may now close this window and continue", foreground='black',  font=("Press Start 2P", 6)).pack()
            adding_data = (
                {
    ...
    if username_input == "" or password_input == "":
        ...
        if username_input in usernames:
            if password_input in user_data["password"].values:
                ...
                lbl_login_success = tk.Label(login_success, text="login success", foreground='black',  font=("Press Start 2P", 6)).pack()
                lbl_can_close = tk.Label(login_success, text="You may now close this window and continue", foreground='black',  font=("Press Start 2P", 6)).pack()
                ...
                lbl_wrong_password = tk.Label(wrong_password, text="That password does not match your username", foreground='black',  font=("Press Start 2P", 6)).pack()
                lbl_can_close = tk.Label(wrong_password, text="You may now close this window and try again", foreground='black', font=("Press Start 2P", 6)).pack()
        else:
            wrong_username = tk.Toplevel(window)
            wrong_username.title("ERROR")
            wrong_username.geometry('250x50')
            lbl_wrong_username = tk.Label(wrong_username, text="That username does not exist", foreground='black', font=("Press Start 2P", 6)).pack()
            lbl_can_close = tk.Label(wrong_username, text="You may now close this window and try again", foreground='black',  font=("Press Start 2P", 6)).pack()
...
def delete_account_sub():
    ...
    lbl_must_input = tk.Label(delete_account_confirm, text="Are you SURE you want to DELETE your account", foreground='black',  font=("Press Start 2P", 6)).pack()
    btn_can_close = tk.Button(delete_account_confirm, text="DELETE ACCOUNT", foreground='black', font=("Press Start 2P", 6), command= delete_account_function_sub).pack()
...
def show_team_sub(character):
    ...
    lbl_poke1 = tk.Label(show_team_window, text=poke_name, fg="black", font=("Press Start 2P", 6)).place(x= 135, y=395)
    ...
    lbl_poke2 = tk.Label(show_team_window, text=poke_name, fg="black", font=("Press Start 2P", 6)).place(x = 395, y=395)
    ...
    lbl_poke3 = tk.Label(show_team_window, text=poke_name, fg="black", font=("Press Start 2P", 6)).place(x= 655, y=395)
    ...
    lbl_poke4 = tk.Label(show_team_window, text=poke_name, fg="black", font=("Press Start 2P", 6)).place(x= 135, y=655)
    ...
    lbl_poke5 = tk.Label(show_team_window, text=poke_name, fg="black", font=("Press Start 2P", 6)).place(x= 395, y=655)
    ...
    lbl_poke6 = tk.Label(show_team_window, text=poke_name, fg="black", font=("Press Start 2P", 6)).place(x= 655, y=655)
...
def check_pokemon_sub():
    ...
    try: 
        ...
        try:
            ...
            btn_invalid_pokemon = tk.Label(inputted_pokemon_window, text="Invalid Pokemon", fg="black", font=("Press Start 2P", 6))
    ...
    if flag == False:   #add to team button doesnt work if invalid pokemon is entered
        ...
        btn_add_to_team = tk.Button(inputted_pokemon_window, text="Add to team", fg="black",background="green", font=("Press Start 2P", 6),
        ...
        btn_not_add_to_team = tk.Button(inputted_pokemon_window, text="dont add to team", fg="black",background="red", height=6, width=12, font=("Press Start 2P", 6),
...
def select_remove_pokemon_sub(pokemon_id):
    ...
    lbl_instruct = tk.Label(select_pokemon_remove_window, text="Select which Pokemon to remove from your team:", fg="black", font=("Press Start 2P", 6), )
...
def replace_pokemon(pokemon_id, placement, select_pokemon_remove_window):
    ...
    btn_replaced_pokemon = tk.Label(replaced_pokemon_window, text="Replaced",  fg="black", font=("Press Start 2P", 6))
...
def on_poke_click(pokemon_id):
    ...
    btn_add_to_team.place(x= 10, y=125)
    #btn to not add to team
    btn_not_add_to_team = tk.Button(inputted_pokemon_window, text="dont add to team",background="red", height=6, width=12, fg="black", font=("Press Start 2P", 6),
    command= lambda: inputted_pokemon_window.destroy())
    btn_not_add_to_team.place(x= 130, y=125)
...
def filter_type_sub():
    ...
    lbl_instruct = tk.Label(type_select_window, text="Select a type for your filter enter [any] to remove a filter",  fg="black", font=("Press Start 2P", 6))
    lbl_instruct.place(x= 5, y=5)
    txt_type_filter = tk.Entry(type_select_window, text="Type", fg="black", font=("Press Start 2P", 6))
    txt_type_filter.place(x= 5, y=30)
    flag = False
    btn_submit_type = tk.Button(type_select_window, text="submit type", fg="black",  font=("Press Start 2P", 6), command= flag == True)
    ...
    if type_entered == "fire":
        ...
        lbl_not_type = tk.Label(not_type_window, text="Invalid type", fg="black",  font=("Press Start 2P", 6))
...
#Back to menu button
back = tk.Button(frm_test_pokedex_menu, text="Back to menu", fg="Black",height=6,width=12, font=("Press Start 2P", 6))
back.place(x= 5, y=5 )
#profile button
#profile button
profile = tk.Button(frm_test_pokedex_menu, text=('profile'), fg='black',height=6, width=12, font=("Press Start 2P", 6))
...
def pokedex_menu_sub(type, index):
    ...
    #Back to menu button
    back = tk.Button(frm_pokedex_menu, text="Back to menu", fg="Black",height=6,width=12, font=("Press Start 2P", 6),  command=lambda: [frm_pokedex_menu.pack_forget(), frm_main_menu.pack()])
    back.place(x= 5, y=5 )
    #profile button
    #profile button
    profile = tk.Button(frm_pokedex_menu, text=('profile'), fg='black',height=6, width=12,  font=("Press Start 2P", 6),  command=lambda: [frm_pokedex_menu.pack_forget(),  frm_profile_menu.pack()])
    profile.place(x=785,y=5)
    #filter button
    btn_filter = tk.Button(frm_pokedex_menu, text = "Filter pokemon", fg= "black", height=6, width=12, font=("Press Start 2P", 6), command=lambda:[frm_pokedex_menu.pack_forget, frm_test_pokedex_menu.pack(), filter_type_sub] )
    btn_filter.place(x= 395, y=5)


    # buton to see next 25
    btn_next_page = tk.Button(frm_pokedex_menu, text = "Next 25", fg= "black", height=6, width=12,  font=("Press Start 2P", 6), command= lambda: [frm_pokedex_menu.pack_forget(), pokedex_menu_sub(type,index + 25)])
...
#Register button
btn_register= tk.Button(frm_reg_or_log, text="Register", fg="Black",height=6,width=12,  font=("Press Start 2P", 6), command=reg_button_press)
...
btn_register= tk.Button(frm_register, text="Register", fg="Black",height=6,width=12,  font=("Press Start 2P", 6), command=reg_button_press)
btn_register.place(x=265, y=135)
##keeping login button
btn_login= tk.Button(frm_register, text="Login", fg="Black",height=6,width=12, font=("Press Start 2P", 6),command=log_in_reg_sub)
btn_login.place(x=525, y=135)
##username label and inoput
lbl_new_username = tk.Label(frm_register, text= 'Enter username',foreground='black', height=6, width=12, font=("Press Start 2P", 6))
lbl_new_username.place(x=265, y=225)
txt_new_username = tk.Entry(frm_register, textvariable='Enter username', foreground='black',  font=("Press Start 2P", 6))
txt_new_username.place(x= 385, y=265)
##Password label and input
lbl_new_password = tk.Label(frm_register, text= 'Enter password',foreground='black', height=6, width=12,  font=("Press Start 2P", 6))
lbl_new_password.place(x=265, y=285)
txt_new_password = tk.Entry(frm_register, textvariable='Enter password', foreground='white',  font=("Press Start 2P", 6))
txt_new_password.place(x= 385, y=325)
##Confirm Password label and input
lbl_conf_password = tk.Label(frm_register, text= 'Confirm password',foreground='black', height=6, width=16, font=("Press Start 2P", 6))
lbl_conf_password.place(x=260, y=345)
txt_conf_password = tk.Entry(frm_register, textvariable='Confirm password', foreground='white', font=("Press Start 2P", 6))
txt_conf_password.place(x= 385, y=385)
##New user submit button
btn_new_submit = tk.Button(frm_register, text='submit', fg='black', height=5,width=12,  font=("Press Start 2P", 6), command=check_new_user)
btn_new_submit.place(x=395,y=525)

#Login button
btn_login= tk.Button(frm_reg_or_log, text="Login", fg="Black",height=6,width=12,  font=("Press Start 2P", 6),command=login_button_press)
btn_login.place(x=525, y=135)
...
##keeping register button
btn_register= tk.Button(frm_login, text="Register", fg="Black",height=6,width=12,  font=("Press Start 2P", 6), command=reg_button_in_login_pressed)
btn_register.place(x=265, y=135)
##keeping login button
btn_login= tk.Button(frm_login, text="Login", fg="Black",height=6,width=12,  font=("Press Start 2P", 6),)
btn_login.place(x=525, y=135)
##username label and inoput
lbl_username = tk.Label(frm_login, text= 'Enter username',foreground='black', height=6, width=12, font=("Press Start 2P", 6))
lbl_username.place(x=525, y=225)
txt_username = tk.Entry(frm_login, textvariable='Enter username', foreground='black',  font=("Press Start 2P", 6))
txt_username.place(x= 385, y=265)
##Password label and input
lbl_password = tk.Label(frm_login, text= 'Enter password',foreground='black', height=6, width=12,  font=("Press Start 2P", 6))
...
##login submit button
btn_new_submit = tk.Button(frm_login, text='submit', fg='black', height=5,width=12,  font=("Press Start 2P", 6), command=check_user_pass)
btn_new_submit.place(x=395,y=525)
...
see_dex = tk.Button(frm_main_menu, text = "See Pokedex", fg="black",height=6,width=12,  font=("Press Start 2P", 6), command=lambda: [pokedex_menu_sub("any", 0)])
see_dex.place(x= 265, y=265)

#see teams button
see_teams = tk.Button(frm_main_menu, text = "See teams \n from anime", fg="black",height=6,width=12,  font=("Press Start 2P", 6),command= see_teams_sub) 
see_teams.place(x=395, y= 265)

#team builder button
team_builder = tk.Button(frm_main_menu, text = "search specific\n pokemon", fg="black",height=6,width=12,  font=("Press Start 2P", 6), command= team_builder_sub)
team_builder.place(x= 525, y=265)

#profile button
profile = tk.Button(frm_main_menu, text=('profile'), fg='black',height=6, width=12,  font=("Press Start 2P", 6), command= lambda: [frm_main_menu.pack_forget(), frm_profile_menu.pack() ] )
profile.place(x=785,y=5)
#########################################################################
...
#logout button
log_out = tk.Button(frm_profile_menu, text = "log out", fg="black",height=6,width=12,  font=("Press Start 2P", 6), command=log_out_sub)
log_out.place(x= 265, y=265)


#see team button
see_team = tk.Button(frm_profile_menu, text = "View your team", fg="black",height=6,width=12,  font=("Press Start 2P", 6), command=lambda: show_team_sub("user") )
see_team.place(x=395, y= 265)

#delete account button
delete_account = tk.Button(frm_profile_menu, text = "Delete account", fg="black",height=6,width=12,  font=("Press Start 2P", 6), command= delete_account_sub )
delete_account.place(x= 525, y=265)

#Back to menu button
back = tk.Button(frm_profile_menu, text="Back to menu", fg="Black",height=6,width=12,  font=("Press Start 2P", 6),command=lambda: [frm_profile_menu.pack_forget(), frm_main_menu.pack()])
back.place(x= 5, y=5 )
...
#back to menu button
back = tk.Button(frm_show_teams_menu, text="Back to menu", fg="Black",height=6,width=12, font=("Press Start 2P", 6), command= lambda: [frm_show_teams_menu.pack_forget(), frm_main_menu.pack()])
back.place(x= 5, y=5 )
#profile button
profile = tk.Button(frm_show_teams_menu, text=('profile'), fg='black',height=6, width=12,  font=("Press Start 2P", 6), command= lambda: [frm_show_teams_menu.pack_forget(), frm_profile_menu.pack() ] )
profile.place(x=785,y=5)
#brocks team
...
#back to menu button
back = tk.Button(frm_make_team, text="Back to menu", fg="Black",height=6,width=12,  font=("Press Start 2P", 6), command= lambda: [frm_make_team.pack_forget(), frm_main_menu.pack()] )
back.place(x= 5, y=5 )
#profile button
#profile button
profile = tk.Button(frm_make_team, text=('profile'), height=6, width=12,  font=("Press Start 2P", 6), command= lambda: [frm_make_team.pack_forget(), frm_profile_menu.pack()] )
profile.place(x=785,y=5)

#what to enter label
lbl_make_team = tk.Label(frm_make_team, text= 'Enter the desired \n pokemons name or \n pokedex number',foreground='black', height=6, width=18, font=("Press Start 2P", 6))
lbl_make_team.place(x= 365, y=275)
#entry for desired pokemon
txt_make_team = tk.Entry(frm_make_team, textvariable='Enter desired pokemon name or pokedex number', foreground='black', font=("Press Start 2P", 6))
txt_make_team.place(x= 365, y=395)
#submitt pokemon
btn_submit_pokemon = tk.Button(frm_make_team, text='submit', fg='black', height=5,width=12, font=("Press Start 2P", 6), command=check_pokemon_sub)
